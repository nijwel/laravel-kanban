        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Dashboard 1</a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/UI/notification.html"><i class="fa fa-circle-o"></i> Notification</a>
                    </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="pages/forms/form-validation.html"><i class="fa fa-circle-o"></i> Form
                            Validation</a></li>
                    <li><a href="pages/forms/form-wizard.html"><i class="fa fa-circle-o"></i> Form Wizard</a>
                    </li>
                    <li><a href="pages/forms/code-editor.html"><i class="fa fa-circle-o"></i> Code Editor</a>
                    </li>
                    <li><a href="pages/forms/editor-markdown.html"><i class="fa fa-circle-o"></i> Editor
                            Markdown</a></li>
